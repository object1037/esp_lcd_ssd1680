...
#define SSD1680_PARAM_OUTPUT_CTRL           ((uint8_t[]) {0x28, 0x01, 0x00}) // height=296: 296%256=40, 296/256=1
...
#define SSD1680_PARAM_DISP_UPDATE_CTRL      ((uint8_t[]) {0x00, 0x80})
#define SSD1680_PARAM_COLOR_BW_INVERSE_BIT  ((uint8_t[]) {0x08, 0x80})
#define SSD1680_PARAM_COLOR_RW_INVERSE_BIT  ((uint8_t[]) {0x80, 0x80})
